...
id_elem.send_keys('nishijayaraj@gmail.com')
id_elem.send_keys(Keys.ENTER)
time.sleep(10)

# Password Login
#pass_elem = browser.find_element_by_name('password')
pass_elem = browser.find_element_by_xpath('/html/body/div[1]/div[1]/div[2]/div/div[2]/div/div/div[2]/div/div[1]/div/form/span/section/div/div/div[1]/div[1]/div/div/div/div/div[1]/div/div[1]/input')
print(pass_elem.value)
pass_elem.send_keys('mookambikadevi')
